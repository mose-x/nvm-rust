...
lazy_static::lazy_static! {
    static ref EN_STRINGS: HashMap<&'static str, &'static str> = {
        ...
        m.insert("upgrading_yarn", "Installing the latest yarn for {0}");
        m.insert("yarn_upgraded", "yarn installed successfully");
        m.insert("yarn_upgrade_failed", "yarn install failed");
        m.insert("upgrading_pnpm", "Installing the latest pnpm for {0}");
        m.insert("pnpm_upgraded", "pnpm installed successfully");
        m.insert("pnpm_upgrade_failed", "pnpm install failed");
        ...
        m.insert("help_desc_install_yarn", "Install the latest yarn");
        m.insert("help_desc_install_pnpm", "Install the latest pnpm");
        m.insert("help_desc_reinstall", "Migrate global packages from a version to current");
        ...
        m.insert("help_install_yarn_about", "Install the latest yarn for a version");
        m.insert("help_install_yarn_usage", "Usage: nvm install-latest-yarn [VERSION]");
        m.insert("help_install_yarn_version_arg", "Version number (defaults to current)");
        m.insert("help_install_pnpm_about", "Install the latest pnpm for a version");
        m.insert("help_install_pnpm_usage", "Usage: nvm install-latest-pnpm [VERSION]");
        m.insert("help_install_pnpm_version_arg", "Version number (defaults to current)");
    ...
    static ref CN_STRINGS: HashMap<&'static str, &'static str> = {
        ...
        m.insert("upgrading_yarn", "正在为 {0} 安装最新版 yarn");
        m.insert("yarn_upgraded", "yarn 安装成功");
        m.insert("yarn_upgrade_failed", "yarn 安装失败");
        m.insert("upgrading_pnpm", "正在为 {0} 安装最新版 pnpm");
        m.insert("pnpm_upgraded", "pnpm 安装成功");
        m.insert("pnpm_upgrade_failed", "pnpm 安装失败");
        ...
        m.insert("help_desc_install_yarn", "安装最新版 yarn");
        m.insert("help_desc_install_pnpm", "安装最新版 pnpm");
        m.insert("help_desc_reinstall", "从指定版本迁移全局包到当前版本");
        ...
        m.insert("help_install_yarn_about", "为某版本安装最新版 yarn");
        m.insert("help_install_yarn_usage", "用法：nvm install-latest-yarn [VERSION]");
        m.insert("help_install_yarn_version_arg", "版本号（默认为当前版本）");
        m.insert("help_install_pnpm_about", "为某版本安装最新版 pnpm");
        m.insert("help_install_pnpm_usage", "用法：nvm install-latest-pnpm [VERSION]");
        m.insert("help_install_pnpm_version_arg", "版本号（默认为当前版本）");
